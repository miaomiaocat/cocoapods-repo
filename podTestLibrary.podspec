...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wangyan/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wangyan' => 'wangyan@syswin.com' }
  s.source           = { :git => 'https://github.com/wangyan/podTestLibrary.git', :tag => s.version.to_s }
